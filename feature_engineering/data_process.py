...
if __name__ == '__main__':
    ...
    sparse_to_adjlist(net_rtr, os.path.join(DATADIR, 'yelp_rsr_adjlists.pickle'))
    sparse_to_adjlist(net_rtr, os.path.join(DATADIR, 'yelp_homo_adjlists.pickle'))
    ...
    for file_name in ['S-FFSD', 'yelp', 'amazon']:
        ...
        features_neigh = pd.DataFrame(
            scaler.fit_transform(features_neigh), columns=features_neigh.columns
        )
